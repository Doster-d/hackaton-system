...
try:
    from .configuration_videollama3_encoder import (
    ...
    spec = importlib.util.spec_from_file_location(
        ...
        osp.join(
            osp.dirname(__file__), 'configuration_videollama3_encoder.py'
        ),
    )
    ...
    Videollama3VisionEncoderConfig = (
        configuration_videollama3_encoder.Videollama3VisionEncoderConfig
    )
...
try:
    ...
    Videollama3VisionEncoderModel = (
        modeling_videollama3_encoder.Videollama3VisionEncoderModel
    )

AutoConfig.register(
    'videollama3_vision_encoder', Videollama3VisionEncoderConfig
)
AutoModel.register(
...
class Videollama3Qwen2Config(Qwen2Config):
    ...
    def __init__(
        ...
        vision_encoder_config: dict[str, Any] | None = None,
